...
// uploadfs init options
var STORAGE_DIR = __dirname + '/storage',
    BASE_URL = "localhost:3000",
    uploadsLocalUrl = '/storage',
    uploadfs_options = {
        backend: 'local',
        uploadsPath: STORAGE_DIR,
        uploadsUrl: 'http://' + BASE_URL + uploadsLocalUrl,
        tempPath: __dirname + '/temp'
    };

// uploadfs init
Message.localFileSystem.init(uploadfs_options, runApp());
...
function runApp() {
    ...
    app.use(uploadsLocalUrl, express.static(STORAGE_DIR));
